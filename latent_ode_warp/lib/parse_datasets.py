...
from generate_warp_timeseries import WarpTimeSeries, variable_time_collate_fn_warp, get_data_min_max
...
def parse_datasets(args, device):
	...
	###############################################
	# Warp dataset
	#Section included to deal with warp.

	if dataset_name == "warp":
		dataset_obj = WarpTimeSeries('data/warp', n_samples = min(300, args.n),
										device = device)
		print(dataset_obj)
		train_size = 0.9
